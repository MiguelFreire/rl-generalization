...
def evaluate_generalization(m, impala=False):
    ...
    test_winrate2 = evaluate_in_testing(agent, start_level=50000, num_levels=500, env=env)
    print("Evaluating Testing 3 \n")
    test_winrate3 = evaluate_in_testing(agent, start_level=60000, num_levels=500, env=env)
